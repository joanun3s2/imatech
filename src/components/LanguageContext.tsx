...
const translations = {
  en: {
    ...
    'nav.about': 'About',
    'nav.contact': 'Contact',
    'hero.headline': 'Available for new projects',
    'hero.title': 'I build modern websites for your business',
    'hero.subtitle':
      "Custom websites designed for high conversion, extreme speed, and stunning aesthetics. Let's grow your digital presence.",
    'hero.cta.quote': 'Get a Quote',
    'hero.cta.work': 'See My Work',
    'services.title': 'My Services',
    'services.subtitle':
      'Tailored digital solutions to help your local business thrive online.',
    'services.web.title': 'Custom Websites',
    'services.web.desc':
      'Hand-crafted websites built from scratch to match your brand identity perfectly.',
    'services.landing.title': 'Landing Pages',
    'services.landing.desc':
      'High-conversion single pages designed to turn visitors into loyal customers.',
    ...
    'about.intro':
      "Hi, I'm a freelance web developer dedicated to helping small businesses succeed in the digital world. I combine technical expertise with creative design.",
  ...
  pt: {
    ...
    'nav.about': 'Sobre',
    'nav.contact': 'Contato',
    'hero.headline': 'Disponível para novos projetos',
    'hero.title': 'Eu crio sites modernos para o seu negócio',
    'hero.subtitle':
      'Sites personalizados projetados para alta conversão, velocidade extrema e estética impressionante. Vamos expandir sua presença digital.',
    'hero.cta.quote': 'Pedir Orçamento',
    'hero.cta.work': 'Ver Meu Trabalho',
    'services.title': 'Meus Serviços',
    'services.subtitle':
      'Soluções digitais sob medida para ajudar seu negócio local a prosperar online.',
    'services.web.title': 'Sites Personalizados',
    'services.web.desc':
      'Sites feitos à mão, criados do zero para combinar perfeitamente com a identidade da sua marca.',
    'services.landing.title': 'Landing Pages',
    'services.landing.desc':
      'Páginas únicas de alta conversão projetadas para transformar visitantes em clientes fiéis.',
    ...
    'contact.subtitle':
      'Pronto para começar seu projeto? Entre em contato por qualquer um dos canais abaixo ou preencha o formulário.',
    'contact.form.name': 'Nome',
    'contact.form.message': 'Mensagem',
    'contact.form.send': 'Enviar Mensagem',
    'contact.form.success': 'Mensagem enviada com sucesso!',
    'contact.workingHours': 'Horas de Trabalho',
