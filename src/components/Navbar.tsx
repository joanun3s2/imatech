        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <div className="flex items-center space-x-2 border-l border-border pl-8">
            <button
              ...
              className={cn("text-xs transition-opacity", language === 'en' ? "opacity-100 font-bold text-primary" : "opacity-50")}
            >
              🇺🇸 EN
            </button>
            ...
            <button
              ...
              className={cn("text-xs transition-opacity", language === 'pt' ? "opacity-100 font-bold text-primary" : "opacity-50")}
            >
              🇧🇷 PT
            </button>
          </div>
